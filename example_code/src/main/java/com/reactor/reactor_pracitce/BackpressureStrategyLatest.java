...
/**
 * Backpressure Latest 전략을 사용하는 예제 클래스
 * Latest 전략은 Downstream이 처리할 수 없는 데이터가 발생하면 
 * 가장 최근에 emit된 데이터만 버퍼에 유지하고 나머지는 버림
 */
public class BackpressureStrategyLatest {
  public static void main(String[] args) throws InterruptedException {
    Flux
        ...
        // Backpressure 전략으로 Latest를 사용
        // Downstream이 처리할 수 없는 데이터 중 가장 최근 데이터만 유지
